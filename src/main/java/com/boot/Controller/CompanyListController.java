...
//    	model.addAttribute("comList", list);
	...
	public String comDetail(@RequestParam(name = "orderType", required = false, defaultValue = "latest") String orderType,
							String com_email, Model model, Criteria4 cri) {//기업정보 상세
